...
public class SwapCaseTest {
  ...
  public SwapCaseTest(String input, String expectedValue) {
    this.input = input;
    this.expectedValue = expectedValue;
  }

  @Test
  public void doSwapCase() {
    Assert.assertEquals("input:" + input , expectedValue, SwapCase.doSwapCase(input));
  }
}
